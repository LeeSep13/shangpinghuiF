              ...
              <ul class="sui-nav">
                <li :class="{ active: isOne }">
                  <a
                    ...
                    >
                      <path
                        d="M325.450697 862.306736"
                        p-id="6069"
                        fill="#ffffff"
                      ></path>
                      <path
                        d="M882.088359 862.306736"
                        p-id="6070"
                        fill="#ffffff"
                      ></path>
                      <path
                        d="M236.00336 877.09995"
                        p-id="6071"
                        fill="#ffffff"
                      ></path>
                      <path
                        d="M960.182765 877.09995"
                        p-id="6072"
                        fill="#ffffff"
                      ></path>
                      <path
                        d="M63.645221 788.684697"
                        p-id="6073"
                        fill="#ffffff"
                      ></path>
                      <path
                        d="M958.462624 788.684697"
                        p-id="6074"
                        fill="#ffffff"
                      ></path>
                      <path
                        d="M64.84932 858.69444"
                        p-id="6075"
                        fill="#ffffff"
                      ></path>
                      <path
                        d="M959.494709 858.69444"
                        p-id="6076"
                        fill="#ffffff"
                      ></path>
                      <path
